...
export const fetchEmployee = createAsyncThunk(
    ...
    async () => {
      const response = await axios.get("http://localhost:6001/employes/");
...
export const insertEmployes = createAsyncThunk(
    ...
    const response = await axios.post("http://localhost:6001/employes/crearEmpleado",{ 
        name: data.name, 
...
export const removeEmploye = createAsyncThunk(
    ...
    async (data) => {
      const response = await axios.delete(
        `http://localhost:6001/employes/eliminarEmpleado/${data}`
      );
...
export const modifiedEmployee = createAsyncThunk(
    ...
    async (data) => {
      ...
      const response = await axios.put(
        `http://localhost:6001/employes/updateEmpleado/${data.id}`,
        {
            name: data.name, 
            last_name: data.last_name, 
            job: data.job, 
